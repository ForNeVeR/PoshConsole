...
// ReSharper restore InconsistentNaming
		...
		{
			get { return PSObject.AsPSObject(Options); }
		}
		...
		private void OnGotUserInput(Object source, CommandEventArgs command)
		{
		...
		private void SettingsPropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
		{
			switch (e.PropertyName)
			{
				...
				case "ScrollBarVisibility":
					{
						_buffer.Dispatcher.BeginInvoke(
							(Action)
								delegate
									{
										_buffer.VerticalScrollBarVisibility =
											(ConsoleScrollBarVisibility) (int) Properties.Settings.Default.ScrollBarVisibility;
									});
					}
					break;
				default:
